...
!(function () {
  ...
  var D = $(
    {},
    { familyPrefix: g, replacementClass: y, autoReplaceSvg: !0, autoAddCss: !0, autoA11y: !0, searchPseudoElements: !1, observeMutations: !0, mutateApproach: "async", keepOriginalSource: !0, measurePerformance: !1, showMissingIcons: !0 },
    F
  );
      ...
      J =
        a.found && n.found
          ? ((C = (k = K).children),
            ...
            (H = "mask-".concat(N || kt())),
            (F = "clip-".concat(N || kt())),
            (D = { tag: "mask", attributes: $({}, zt, { id: H, maskUnits: "userSpaceOnUse", maskContentUnits: "userSpaceOnUse" }), children: [I, Y] }),
            (U = { tag: "defs", children: [{ tag: "clipPath", attributes: { id: F }, children: ((A = L), "g" === A.tag ? A.children : [A]) }, D] }),
            C.push(U, { tag: "rect", attributes: $({ fill: "currentColor", "clip-path": "url(#".concat(F, ")"), mask: "url(#".concat(H, ")") }, zt) }),
    ...
    return (
      ...
      c
        ? ((q = (W = K).prefix),
          ...
          (B = W.attributes),
          (G = W.symbol),
          [{ tag: "svg", attributes: { style: "display: none;" }, children: [{ tag: "symbol", attributes: $({}, B, { id: !0 === G ? "".concat(q, "-").concat(et.familyPrefix, "-").concat(V) : G }), children: X }] }])
        : (function (t) {
            var e = t.children,
              n = t.main,
              a = t.mask,
      ...
      (oe = new l(function (t) {
        re ||
          At(t).forEach(function (t) {
            if (
              ("childList" === t.type && 0 < t.addedNodes.length && !te(t.addedNodes[0]) && (et.searchPseudoElements && o(t.target), r(t.target)),
  ...
  function fe(t) {
    var e,
      ...
      g =
        ...
        et.autoA11y && (o ? (i["aria-labelledby"] = "".concat(et.replacementClass, "-title-").concat(c || kt())) : ((i["aria-hidden"] = "true"), (i.focusable = "false"))),
        i),
  ...
  var de = { fill: "currentColor" },
    ...
    ge = {
      ...
      children: [
        ...
        {
          tag: "path",
          attributes: $({}, de, { opacity: "0", d: "M232.5,134.5l7,168c0.3,6.4,5.6,11.5,12,11.5h9c6.4,0,11.7-5.1,12-11.5l7-168c0.3-6.8-5.2-12.5-12-12.5h-23 C237.7,122,232.2,127.7,232.5,134.5z" }),
    ...
    return {
      ...
      icon: Array.isArray(a)
        ? {
            ...
            children: [
              { tag: "path", attributes: { class: "".concat(et.familyPrefix, "-").concat(Y.SECONDARY), fill: "currentColor", d: a[0] } },
    ...
    _e = {
      ...
      watch: function () {
        ...
        !1 === et.autoReplaceSvg && (et.autoReplaceSvg = !0),
          ...
          X(function () {
            He({ autoReplaceSvgRoot: e }), ce({ treeCallback: ke, nodeCallback: Ae, pseudoElementsCallback: Se, observeMutationsRoot: n });
          });
      },
    },
    Te =
      ((Le = function (t) {
        ...
        if (t) {
          ...
          return Ee($({ type: "icon" }, t), function () {
            return (
              ze(),
              et.autoA11y && (u ? (v["aria-labelledby"] = "".concat(et.replacementClass, "-title-").concat(m || kt())) : ((v["aria-hidden"] = "true"), (v.focusable = "false"))),
              jt({
    ...
    Ye = {
      ...
      text: function (t) {
        ...
        return Ee({ type: "text", content: t }, function () {
          return ze(), Lt({ content: t, transform: $({}, yt, a), title: i, extra: { attributes: l, styles: u, classes: ["".concat(et.familyPrefix, "-layers-text")].concat(d(c)) } });
        });
      },
      counter: function (t) {
        var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
